...
public:
	...
	void SetCharacterInfo(const CHARACTER_CALCULATED_INFO& info) { _info = info; }
	...
	const CHARACTER_CALCULATED_INFO& GetCharacterInfo() const { return _info; }
public:
...
private:
	...
	CHARACTER_CALCULATED_INFO	_info;
};