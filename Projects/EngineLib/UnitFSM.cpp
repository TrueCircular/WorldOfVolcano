...
void UnitFSM::Enter(const shared_ptr<AIController>& controller)
{
	_strategy->Enter(controller);
}
...
void UnitFSM::Out(const wstring& transition)
{
	_strategy->Out(transition);
}
